...
import { doesStateHaveResponseData, setupDriver, getMockApiConnector, searchResponse, getMockApiConnectorWithStateAndActions, waitATick, mockPlugin } from "../test/helpers";
...
it("can be initialized", () => {
    const driver = new SearchDriver(Object.assign(Object.assign({}, params), { onSearch: () => Promise.resolve(searchResponse) }));
...
it("will use initial state if provided", () => {
    ...
    expect(stateAfterCreation).toEqual(Object.assign(Object.assign({}, DEFAULT_STATE), initialState));
});
...
describe("searchQuery config", () => {
    ...
    describe("conditional facets", () => {
        function subject(conditional) {
            const driver = new SearchDriver(Object.assign(Object.assign({}, params), { initialState: {
                    filters: [
    ...
    describe("pass through values", () => {
        function subject({ disjunctiveFacets, disjunctiveFacetsAnalyticsTags, result_fields, search_fields }) {
            const driver = new SearchDriver(Object.assign(Object.assign({}, params), { searchQuery: {
                    facets: {
                        initial: {
                            type: "value"
                        }
...
describe("autocompleteQuery config", () => {
    function subject(config) {
        const driver = new SearchDriver(Object.assign(Object.assign({}, params), { autocompleteQuery: {
                results: config
            } }));
