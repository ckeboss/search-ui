...
describe("#onSearch", () => {
    function subject({ beforeSearchCall = undefined, state, queryConfig = {} }) {
        const connector = new SiteSearchAPIConnector(Object.assign(Object.assign({}, params), { beforeSearchCall }));
...
describe("#onAutocomplete", () => {
    function subject({ beforeAutocompleteResultsCall = undefined, state, queryConfig = {
        ...
        const connector = new SiteSearchAPIConnector(Object.assign({ beforeAutocompleteResultsCall }, params));
