...
describe("adaptRequest", () => {
    it("adapts request", () => {
        expect((0, requestAdapter_1.default)(requestState, queryConfig, "national-parks")).toEqual(adaptedRequest);
    });
    it("adapts empty request", () => {
        expect((0, requestAdapter_1.default)(emptyRequestState, {}, "")).toEqual(adaptedEmptyRequest);
    });
});
