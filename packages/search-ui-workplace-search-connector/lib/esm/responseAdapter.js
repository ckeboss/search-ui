...
export function adaptResponse(response, options = {}) {
    ...
    const totalPages = response.meta.page && typeof response.meta.page.total_pages !== "undefined"
        ? limitTo100pages(response.meta.page.total_pages)
        : undefined;
    const totalResults = response.meta.page
        ? response.meta.page.total_results
        : undefined;
    return Object.assign(Object.assign(Object.assign(Object.assign({}, (facets && { facets: adaptFacets(facets, options) })), { rawResponse: response, requestId, results: response.results }), (totalPages !== undefined && { totalPages })), (totalResults !== undefined && { totalResults }));
}
