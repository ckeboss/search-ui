...
beforeEach(() => {
    ...
    window.fetch = jest.fn(() => Promise.resolve({
        status: 200,
        json: () => Promise.resolve(exampleResponse_json_1.default)
    }));
});
...
describe("WorkplaceSearchAPIConnector", () => {
    ...
    describe("Result click Analytics Event", () => {
        function subject() {
            const connector = new __1.default(Object.assign({}, params));
            return connector.onResultClick({
                documentId: "11111",
                requestId: "12345",
                page: 2,
                result: exampleResponse_json_1.default.results[0],
                resultsPerPage: 20,
                resultIndexOnPage: 4
            });
        }
    ...
    describe("onSearch", () => {
        function subject(state = Object.assign({}, search_ui_1.DEFAULT_STATE), queryConfig = {}, beforeSearchCall) {
        ...
        it("will pass request state through to search endpoint", () => __awaiter(void 0, void 0, void 0, function* () {
            const state = Object.assign(Object.assign({}, search_ui_1.DEFAULT_STATE), { resultsPerPage: 40, current: 2, sortField: "foo", sortDirection: "desc" });
            yield subject(state);
      ...
      `);
        ...
        it("will pass queryConfig to search endpoint", () => __awaiter(void 0, void 0, void 0, function* () {
            const state = Object.assign({}, search_ui_1.DEFAULT_STATE);
            const queryConfig = {
                facets: {
                    states: {
                        type: "value",
      ...
      `);
        ...
        it("will not pass empty facets or filter state to search endpoint", () => __awaiter(void 0, void 0, void 0, function* () {
            const state = Object.assign(Object.assign({}, search_ui_1.DEFAULT_STATE), { searchTerm: "searchTerm", filters: [], facets: {} });
            const queryConfig = {
                filters: [],
                facets: {}
            };
      ...
      `);
        ...
        it("will pass request parameter state provided to queryConfig, overriding the same value provided in state", () => __awaiter(void 0, void 0, void 0, function* () {
            const state = Object.assign(Object.assign({}, search_ui_1.DEFAULT_STATE), { searchTerm: "searchTerm", current: 1, resultsPerPage: 10, sortDirection: "desc", sortField: "name", filters: [
                    {
                        field: "title",
                        type: "all",
      ...
      `);
        ...
        it("will include meta header information correct for the browser context", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(metaHeader).toEqual(`ent=${version_1.LIB_VERSION}-ws-connector,js=browser,t=${version_1.LIB_VERSION}-ws-connector,ft=universal`);
        ...
        it("will use the beforeSearchCall parameter to amend option parameters to the search endpoint call", () => __awaiter(void 0, void 0, void 0, function* () {
            const state = Object.assign(Object.assign({}, search_ui_1.DEFAULT_STATE), { current: 2, searchTerm: "searchTerm" });
            const queryConfig = {
                sortDirection: "desc",
                sortField: "name",
                resultsPerPage: 5
    ...
    describe("onAutocomplete", () => {
        function subject(state = { searchTerm: "searchTerm" }, queryConfig = {}, { beforeAutocompleteResultsCall, beforeAutocompleteSuggestionsCall } = {}) {
            window.location.hash = "access_token=faketoken";
            const connector = new __1.default(Object.assign(Object.assign({}, params), { beforeAutocompleteResultsCall,
        ...
        `);
                expect(getLastFetchCall().headers["x-elastic-client-meta"]).toEqual(`ent=${version_1.LIB_VERSION}-ws-connector,js=browser,t=${version_1.LIB_VERSION}-ws-connector,ft=universal`);
            }));
            it("will pass queryConfig to search endpoint", () => __awaiter(void 0, void 0, void 0, function* () {
                const queryConfig = {
                    facets: {
